      ...
      <div className="learn">
              ...
              <div className="learn-img">
                <img
                  src={intl.formatMessage({
                    id: `developerPage.learnHeadingData.img`,
                  })}
                  alt="learn"
        ...
        <div className="learn-list">
          {learnMoreData.map((learnList, index) => {
            const { id, heading, link, imgSrc } = learnList
            return (
              <div className="list" key={id}>
                <a
                  href={intl.formatMessage({
                    id: `developerPage.learnMoreData.${index}.link`,
                  })}
                  target="_blank"
                ...
                >
                  <div className="list-text">
                    <h4 className="wow fadeInUp" data-wow-duration="600">
                      {intl.formatMessage({
                        id: `developerPage.learnMoreData.${index}.heading`,
                      })}{" "}
                    </h4>
                  </div>
                  <div className="list-icon">
                    <img
                      src={intl.formatMessage({
                        id: `developerPage.learnMoreData.${index}.imgSrc`,
                      })}
                      alt="learn"
