                    ...
                    <div className="container">
                        <Link to="/developer">
                            <div className="developer-potal">
                                ...
                                <h3><FormattedMessage id="home.updates.developer.title" /></h3>
                                <p><FormattedMessage id="home.updates.developer.description" /></p>
                        ...
                        <Link to="/foundation">
                            <div className="fantom-foundation">
                                <div className="card-img wow fadeInUp" data-wow-duration="1000" data-wow-delay="0.6s"> </div>
                                <h3><FormattedMessage id="home.updates.foundation.title" /></h3>
                                <p><FormattedMessage id="home.updates.foundation.description" /></p>
                                <div className="intro-button">
                                  <FormattedMessage id="learnMore" />
                                </div>
                            </div>
